...
contract Crowdsale is Context, ReentrancyGuard, WhitelistedRole, CapperRole {
    using SafeMath for uint256;
     ...
     * @param weiAmount Amount of wei contributed
     */
    function _preValidateTimePurchase(address beneficiary, uint256 weiAmount) internal onlyWhileOpen view {
        _preValidatePurchase(beneficiary, weiAmount);
    }
